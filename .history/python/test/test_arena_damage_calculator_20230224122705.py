from src.arena_damage_calculatorarena_damage_calculator import ArenaDamageCalculator, Hero, HeroElement, Buff
import pytest
import displ
...
def test_compute_damage_with_attack_buff():
    ...
    display(attackers.buffs)
    assert ArenaDamageCalculator().computeDamage(attackers, defenders) == defenders