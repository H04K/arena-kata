...
def test_compute_damage_with_attackers_adv_earth():
    ...
    defenders = [Hero(HeroElement.FIRE,100,100,100,100,100), Hero(HeroElement.WATER,100,100,100,100,100), Hero(HeroElement.W,100,100,100,100,100),Hero(HeroElement.EARTH,100,100,100,100,100)]
