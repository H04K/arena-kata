...
def test_compute_damage_with_attackers_adv_water():
    ...
    buff_defenders_fire= Buff(2)
    buff_defenders_earth = Buff(2)
    attackers = Hero(HeroElement.WATER,100,100,100,100,100)
    defenders = [Hero(HeroElement.FIRE,100,100,100,100,100), Hero(HeroElement.WATER,100,100,100,100,100), Hero(HeroElement.EARTH,100,100,100,100,100)]
...
def test_compute_damage_with_attackers_adv_earth():
    buff_attacker = Buff(1)
    buff_defenders_water = Buff(2)
    buff_defenders_fire= Buff(2)
    buff_defenders_earth = Buff(2)
    attackers = Hero(HeroElement.EARTH,100,100,100,100,100)
    defenders = [Hero(HeroElement.FIRE,100,100,100,100,100), Hero(HeroElement.WATER,100,100,100,100,100), Hero(HeroElement.EARTH,100,100,100,100,100),Hero(HeroElement.WATER,100,100,100,100,100)]
